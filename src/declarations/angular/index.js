...
export const canisterId = process.env.ANGULAR_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./angular.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the angular canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./angular.did.js")._SERVICE>}
 */
export const angular = createActor(canisterId);
